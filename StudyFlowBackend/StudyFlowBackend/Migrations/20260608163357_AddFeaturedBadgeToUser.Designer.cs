...
namespace StudyFlowBackend.Migrations
{
    ...
    [Migration("20260608163357_AddFeaturedBadgeToUser")]
    partial class AddFeaturedBadgeToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudyFlowBackend.Models.Badge", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1780),
                            Description = "Đạt cấp độ 5",
                            IconUrl = "school",
                            MetricType = "Level",
                            Name = "Tân Binh Tập Sự",
                            ThresholdValue = 5
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1793),
                            Description = "Đạt cấp độ 10",
                            IconUrl = "workspace_premium",
                            MetricType = "Level",
                            Name = "Học Giả Nghiêm Túc",
                            ThresholdValue = 10
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1796),
                            Description = "Đạt cấp độ 20",
                            IconUrl = "psychology",
                            MetricType = "Level",
                            Name = "Bậc Thầy Trí Tuệ",
                            ThresholdValue = 20
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1799),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1802),
                            Description = "Tập trung học tập tổng cộng 1 giờ (60 phút)",
                            IconUrl = "timer",
                            MetricType = "FocusMinutes",
                            Name = "Khởi Đầu Tập Trung",
                            ThresholdValue = 60
                        },
                        new
                        {
                            Id = new Guid("66666666-6666-6666-6666-666666666666"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1804),
                            Description = "Tập trung học tập tổng cộng 10 giờ (600 phút)",
                            IconUrl = "hourglass_full",
                            MetricType = "FocusMinutes",
                            Name = "Chiến Binh Tập Trung",
                            ThresholdValue = 600
                        },
                        new
                        {
                            Id = new Guid("77777777-7777-7777-7777-777777777777"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1806),
                            Description = "Tập trung học tập tổng cộng 50 giờ (3000 phút)",
                            IconUrl = "self_improvement",
                            MetricType = "FocusMinutes",
                            Name = "Thiền Sư Học Tập",
                            ThresholdValue = 3000
                        },
                        new
                        {
                            Id = new Guid("88888888-8888-8888-8888-888888888888"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1814),
                            Description = "Tập trung học tập tổng cộng 100 giờ (6000 phút)",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1816),
                            Description = "Hoàn thành 1 nhiệm vụ đầu tiên",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1818),
                            Description = "Hoàn thành tổng cộng 10 nhiệm vụ",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1820),
                            Description = "Hoàn thành tổng cộng 50 nhiệm vụ",
                            IconUrl = "trending_up",
                            MetricType = "TasksCompleted",
                            Name = "Năng Suất Vượt Trội",
                            ThresholdValue = 50
                        },
                        new
                        {
                            Id = new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1822),
                            Description = "Đạt chuỗi 3 ngày học liên tiếp",
                            IconUrl = "bolt",
                            MetricType = "StreakDays",
                            Name = "Khởi Động Streak",
                            ThresholdValue = 3
                        },
                        new
                        {
                            Id = new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"),
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1824),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 8, 16, 33, 57, 289, DateTimeKind.Utc).AddTicks(1827),
